...
#if COMMERCIAL
#define BORD_LOWER_RIGHT_CORNER  CHR_ROUNDED_LOWER_RIGHT
#define BORD_LOWER_LEFT_CORNER   CHR_ROUNDED_LOWER_LEFT
#define BORD_UPPER_RIGHT_CORNER  CHR_ROUNDED_UPPER_RIGHT
#define BORD_UPPER_LEFT_CORNER   CHR_ROUNDED_UPPER_LEFT
#else
